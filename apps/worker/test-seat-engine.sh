...
res=$(post "reserveSeat" '{"eventId":"alarm-test-event","seatCount":1}')
...
res=$(post "confirmBooking" "{\"holdId\":\"$HOLD_ID\",\"eventId\":\"alarm-test-event\"}")
...
res=$(post "releaseBooking" "{\"holdId\":\"$NEW_HOLD_ID\",\"eventId\":\"alarm-test-event\"}")
...
res=$(post "confirmBooking" '{"holdId":"00000000-0000-0000-0000-000000000000","eventId":"alarm-test-event"}')
...
res=$(get "getAvailableSeats" "%7B%22eventId%22%3A%22alarm-test-event%22%7D")
